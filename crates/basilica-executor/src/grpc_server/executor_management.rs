...
impl ExecutorManagement for ExecutorManagementService {
    ...
    async fn get_status(
        ...
        // Build machine info
        let machine_info = basilica_protocol::common::MachineInfo {
            gpus: system_info
                .gpu
                .iter()
                .map(|g| basilica_protocol::common::GpuSpec {
                    model: g.name.clone(),
                ...
                .collect(),
            cpu: Some(basilica_protocol::common::CpuSpec {
            ...
            memory: Some(basilica_protocol::common::MemorySpec {
            ...
            os_info: Some(basilica_protocol::common::OsInfo {
        ...
        // Build OS info
        let _os_info = basilica_protocol::common::OsInfo {
            name: system_info.system.os_name.clone(),
            version: system_info.system.os_version.clone(),
            kernel_version: system_info.system.kernel_version.clone(),
            distribution: system_info.system.os_name.clone(),
