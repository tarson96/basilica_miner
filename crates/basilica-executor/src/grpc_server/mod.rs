...
impl ExecutorControl for ExecutorControlService {
    ...
    async fn execute_system_profile(
        ...
        Ok(tonic::Response::new(SystemProfileResponse {
            encrypted_profile,
            encryption_nonce,
            collected_at: Some(basilica_protocol::common::Timestamp {
                ...
                if let Some(spec) = req.container_spec {
                    ...
                    Ok(tonic::Response::new(ContainerOpResponse {
                        ...
                        status: Some(basilica_protocol::common::ContainerStatus {
                            ...
                            created_at: Some(basilica_protocol::common::Timestamp {
            ...
            "delete" | "destroy" => {
                ...
                Ok(tonic::Response::new(ContainerOpResponse {
                    ...
                    status: Some(basilica_protocol::common::ContainerStatus {
                        ...
                        created_at: None,
                        started_at: None,
                        finished_at: Some(basilica_protocol::common::Timestamp {
        ...
        match self.health_check.health_check().await {
            Ok(health_status) => {
                ...
                Ok(tonic::Response::new(HealthCheckResponse {
                    ...
                    last_update: Some(basilica_protocol::common::Timestamp {
                        value: Some(prost_types::Timestamp::from(std::time::SystemTime::now())),
                    }),
