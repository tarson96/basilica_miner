...
use basilica_executor::config::SystemConfig;
use basilica_executor::system_monitor::types::BasicSystemInfo;
use basilica_executor::system_monitor::{
...
impl basilica_executor::system_monitor::SystemMonitor for MockSystemMonitor {
    async fn get_system_info(&self) -> anyhow::Result<BasicSystemInfo> {
        Ok(BasicSystemInfo {
            system: basilica_executor::system_monitor::types::SystemInfo {
            ...
            cpu: basilica_executor::system_monitor::types::CpuInfo {
                cores: 8,
            ...
            memory: basilica_executor::system_monitor::types::MemoryInfo {
            ...
            disk: vec![basilica_executor::system_monitor::types::DiskInfo {
            ...
            network: basilica_executor::system_monitor::types::NetworkInfo {
                interfaces: vec![basilica_executor::system_monitor::types::NetworkInterfaceInfo {
                    name: "eth0".to_string(),
            ...
            gpu: vec![basilica_executor::system_monitor::types::GpuInfo {
                index: 0,
...
fn test_cpu_info_creation() {
    let cpu = basilica_executor::system_monitor::types::CpuInfo {
        cores: 16,
...
fn test_memory_info_calculations() {
    let memory = basilica_executor::system_monitor::types::MemoryInfo {
...
fn test_disk_info_validation() {
    let disk = basilica_executor::system_monitor::types::DiskInfo {
...
fn test_network_interface_info() {
    let iface = basilica_executor::system_monitor::types::NetworkInterfaceInfo {
...
fn test_gpu_info_validation() {
    let gpu = basilica_executor::system_monitor::types::GpuInfo {
        index: 0,
